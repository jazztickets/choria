...
const  float        BATTLE_SUMMON_SHARE_PERCENT     =  3;
...
const  double       GAME_DIFFICULTY_PER_PLAYER_BOSS =  0.2;
...
const  float        INVENTORY_TOOLTIP_HEIGHT        =  550;
const  float        INVENTORY_TOOLTIP_HEIGHT_EXTRA  =  146;
