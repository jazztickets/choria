...
cp      $in/ctl.png              $out/ctl.png
convert $in/ctl.png -rotate 90   $out/ctr.png
convert $in/ctl.png -rotate 180  $out/cbr.png
convert $in/ctl.png -rotate 270  $out/cbl.png
...
cp $out/ctr.png $out/10.png
convert $out/l.png $out/r.png -evaluate-sequence max $out/11.png
convert $out/ctl.png $out/ctr.png -evaluate-sequence max $out/12.png
...
convert $out/ctr.png $out/bl.png -evaluate-sequence max $out/20.png
...
cp $out/cbl.png $out/26.png
convert $out/ctl.png $out/cbl.png -evaluate-sequence max $out/27.png
convert $out/cbl.png $out/tr.png -evaluate-sequence max $out/28.png
cp $out/cbr.png $out/29.png
convert $out/cbr.png $out/tl.png -evaluate-sequence max $out/30.png
convert $out/ctr.png $out/cbr.png -evaluate-sequence max $out/31.png
convert $out/cbl.png $out/cbr.png -evaluate-sequence max $out/32.png
convert $out/ctl.png $out/ctr.png $out/cbl.png $out/cbr.png -evaluate-sequence max $out/33.png
...
convert $out/ctl.png $out/br.png -evaluate-sequence max $out/40.png
